...
PROMPT_COMMAND='history -a'     # After every command, before displaying prompt (the green and blue thing with user + hostname), append unwritten history to history file.
